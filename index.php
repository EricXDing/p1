...
</br>As a matter of fact, I think certain aspects of law (especially corporate law) is very similar to computer programming. A legal contract is essentially a program. Different &#34functions&#34 need to be defined first in the definition section, and then programmed to interact with each other to achieve the desired effect. 
...
</br>I really look forward to continue studying in the HES&#39s software enginnering program. I want to challenge myself, and I look forward to this class!
<hr>
...
$quote2 = "We the people tell the government what to do, it doesn&#39t tell us. - Ronald Reagan";
